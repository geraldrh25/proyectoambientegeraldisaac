	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="View/restaurantes.php" class="dropdown-item">Restaurantes</a></li>
                <li><a href="View/gestionRestaurante.php" class="dropdown-item">Gestion de Restaurantes</a></li>
              </ul>
            </li>
	        </ul>
	      </div>
